...
-- ============================================================================
-- Visio 图表 visio_diagram_*（v20 已落地）
-- ============================================================================

-- 当前 Visio 图表流程单例状态。VSDX、PNG、plan.json 与 manifest.json
-- 保存到 workspace/visio-diagram/revisions/，SQLite 只保存状态和活动产物索引。
